...
exports.provisioningProfilesDirectories = provisioningProfilesDirectories;
...
function detect(options, callback) {
	return magik(options, callback, function (emitter, options, callback) {
		var files = {},
			...
			profileDir = getPrimaryProvisioningProfileDirectory(options.profileDir),
			results = {
				provisioning: {
...
function unwatch(profileDir) {
	var profileDir = getPrimaryProvisioningProfileDirectory(profileDir);
 ...
 * @returns {string | undefined} Either a matching directory or `undefined`, if directory could be found.
 */
function getPrimaryProvisioningProfileDirectory(profileDir) {
	if (profileDir) {
		return appc.fs.resolvePath(profileDir);
	}

	for (const directory of provisioningProfilesDirectories) {
